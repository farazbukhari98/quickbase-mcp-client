...
export default function DashboardPage() {
  ...
  return (
    <div className="p-8">
      ...
      {/* Top Projects */}
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Top 5 Projects by Value</h3>
        {isLoading ? (
          <div className="text-sm text-muted-foreground">Loading...</div>
              ...
              <div key={project.id} className="flex items-center justify-between py-2 border-b last:border-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground truncate max-w-md">{project.projectName}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold">{formatCurrency(project.budgetRevenue)}</p>
